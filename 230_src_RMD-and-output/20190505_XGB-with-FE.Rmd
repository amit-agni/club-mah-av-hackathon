...
################### Testing bayes opt by keeping only 2 variables ################

#vars <- c("flag","roomnights","length_of_stay","amount_spent_per_room_night_scaled")
...
### Bayesian Optimisation (PART I) : eta AND nrounds
...
opt_res <- BayesianOptimization(opt_fn
                                ,bounds = list(
                                    ...
                                    ,eta = c(0.05,0.3))
                                #,init_grid_dt = NULL
                                ,init_grid_dt = data.table(nrounds = 100L,eta = 1)
                                ,init_points = 10
                                ,n_iter = 30
                                ,acq = "ei"
                                ,kappa = 2.576
