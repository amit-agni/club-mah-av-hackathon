---
title: "AV Club Mahindra Data Olympics"
author: "Amit Agni"
...
This is a quick summary for the 
[Club Mahindra Data Competition](https://datahack.analyticsvidhya.com/contest/club-mahindra-dataolympics/) that was hosted by Analytics Vidhya between 3-5May 2019. The objective was to predict the average spend of hotel guests on Food and Beverages

* My best score (RMSE) was 96.68 with a private leaderboard rank of 220 out of 983
...
* Decision tree based algos tend to give preference to continuous variables [Source] (https://stackoverflow.com/questions/51601122/xgboost-minimize-influence-of-continuous-linear-features-as-opposed-to-categori)
...
### Other LB Solutions
* [LB Rank 1 solution](https://github.com/sahil711/AV/tree/master/Club%20Mahindra%20DataOlympics)

* [LB Rank 50 solution] (https://github.com/sk48880/AV--Club-Mahindra-DataOlympics/blob/master/Club_Mahindra_DataOlympics_EDA%2C_Feature_Eng_%2C_Catboost_%26_LGBM.ipynb)
    + group by mean,max,min features

* [LB Rank 12 solution]
(https://github.com/skg01/Competition/tree/master/AV_Club_Mahindra)
    + Did he use the target column to create features ?
    
* [LB Rank 2 solution]
(https://github.com/bishwarup307/AV_ClubMahindra)

https://discuss.analyticsvidhya.com/t/3rd-place-solution-club-mahindra-dataolympics/80519/11
...
* Try 2
  ...
  + Stopping. Best iteration: [418]	test-rmse:0.951616	train-rmse:0.947857
  + Gave LB Score of 96.6886094264532

* Try 3
  + nrounds = 300.0000	eta = 0.1889	max_depth = 4.0000	gamma = 4.8701	Value = -0.9729 
  + Stopping. Best iteration: [193]	test-rmse:0.973284	train-rmse:0.963898
